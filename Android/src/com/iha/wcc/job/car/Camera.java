...
public class Camera {
    ...
    public static String getCommand(){
        return "mjpg_streamer -i \"input_uvc.so -d /dev/video0 -r "+DEFAULT_CAMERA_WIDTH+"*"+DEFAULT_CAMERA_HEIGHT+"\" -o \"output_http.so -p 8080 -w /mnt/share\"";
    }
    ...
    public static String getCommand(SharedPreferences prefs){
        return "mjpg_streamer -i \"input_uvc.so -d /dev/video0 -r "+getCameraWidth(prefs)+"*"+getCameraHeight(prefs)+"\" -o \"output_http.so -p 8080 -w /mnt/share\"";
    }
}
